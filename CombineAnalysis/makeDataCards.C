...
string inputdir = "../StopLooper/rootfiles/";
...
void addCorrelatedUnc(std::ostringstream *fLogStream, string name, double *d, double *u, int bin, string unctype);
void addOneUnc(std::ostringstream *fLogStream, string name, double d, double u, int process, int bin, string unctype);
...
void makeDataCardsOneBinBasis(int bin, TString signaltype, int analysis, bool dropsigcont, bool correlated, int stop, int lsp, int charg, float xval, bool fakedata, bool nosigsyst, bool nobgsyst){
  ...
  sig = histSig["SRyield"]->GetBinContent(b3);
  ...
  */
  ...
  data = histData["Data"]->GetBinContent(b);

  bg2l = hist2l["CR2lyield"]->GetBinContent(bLL);
  ++nbgs;
  if(bg2l>0) { bg2lerr = 1.+((hist2l["CR2lyield"]->GetBinError(bLL))/bg2l); ++nnuis;}
  bg1l = hist1l["CR1lyield"]->GetBinContent(bW);
  ++nbgs;
  if(bg1l>0) { bg1lerr = 1.+((hist1l["CR1lyield"]->GetBinError(bW))/bg1l); ++nnuis;}
  bg1ltop = hist1ltop["tt1lyield"]->GetBinContent(bW);
  ++nbgs;
  if(bg1ltop>0) { bg1ltoperr = 1.; ++nnuis;} //- no statistical uncertainty on 1ltop !!!
  bgznunu = histZnunu["h_signal_bins_rare"]->GetBinContent(bTTZ);
  ++nbgs;
  if(bgznunu>0) { bgznunuerr = 1.+((histZnunu["h_signal_bins_rare"]->GetBinError(bTTZ))/bgznunu); ++nnuis;}

  bool up = false; bool down = false;
  if(!nosigsyst){
    nnuis += getSigUncertainty(vSig["SR_Bup_HF"],     vSig["SR_Bdown_HF"],     osig, histSig["SR_Bup_HF"],     histSig["SR_Bdown_HF"],     b3);
    nnuis += getSigUncertainty(vSig["SR_Bup_LF"],     vSig["SR_Bdown_LF"],     osig, histSig["SR_Bup_LF"],     histSig["SR_Bdown_LF"],     b3);
    nnuis += getSigUncertainty(vSig["SR_JESup"],      vSig["SR_JESdown"],      osig, histSig["SR_JESup"],      histSig["SR_JESdown"],      b3);
    nnuis += getSigUncertainty(vSig["SR_muRFup"],     vSig["SR_muRFdown"],     osig, histSig["SR_muRFup"],     histSig["SR_muRFdown"],     b3);
    nnuis += getSigUncertainty(vSig["SR_ISRup"],      vSig["SR_ISRdown"],      osig, histSig["SR_ISRup"],      histSig["SR_ISRdown"],      b3);
    nnuis += getSigUncertainty(vSig["SR_LepEffup"],   vSig["SR_LepEffdown"],   osig, histSig["SR_LepEffup"],   histSig["SR_LepEffdown"],   b3);
    nnuis += getSigUncertainty(vSig["SR_LepEffFSup"], vSig["SR_LepEffFSdown"], osig, histSig["SR_LepEffFSup"], histSig["SR_LepEffFSdown"], b3);
    vSig["triggerr"]        = 1.03;  ++nnuis;//also on any other simulation
    vSig["lumierr"]         = 1.027; ++nnuis;//also on any other simulation
    vSig["SR_PUerr"]        = 1.05;  ++nnuis;
    vSig["SR_LEffVetoerr"]  = 1.03;  ++nnuis;
  }

  if(!nobgsyst){
    nnuis += getBGUncertainty(v2l["CR2l_Bup_HF"],      v2l["CR2l_Bdown_HF"],      bg2l, hist2l["CR2l_Bup_HF"],      hist2l["CR2l_Bdown_HF"],      bLL);
    nnuis += getBGUncertainty(v2l["CR2l_Bup_LF"],      v2l["CR2l_Bdown_LF"],      bg2l, hist2l["CR2l_Bup_LF"],      hist2l["CR2l_Bdown_LF"],      bLL);
    nnuis += getBGUncertainty(v2l["CR2l_LepEffup"],    v2l["CR2l_LepEffdown"],    bg2l, hist2l["CR2l_LepEffup"],    hist2l["CR2l_LepEffdown"],    bLL);
    nnuis += getBGUncertainty(v2l["CR2l_diNuSFup"],    v2l["CR2l_diNuSFdown"],    bg2l, hist2l["CR2l_diNuSFup"],    hist2l["CR2l_diNuSFdown"],    bLL);
    nnuis += getBGUncertainty(v2l["CR2l_nJetsSFK3up"], v2l["CR2l_nJetsSFK3down"], bg2l, hist2l["CR2l_nJetsSFK3up"], hist2l["CR2l_nJetsSFK3down"], bLL);
    nnuis += getBGUncertainty(v2l["CR2l_nJetsSFK4up"], v2l["CR2l_nJetsSFK4down"], bg2l, hist2l["CR2l_nJetsSFK4up"], hist2l["CR2l_nJetsSFK4down"], bLL);
    nnuis += getBGUncertainty(v2l["CR2l_PDFup"],       v2l["CR2l_PDFdown"],       bg2l, hist2l["CR2l_PDFup"],       hist2l["CR2l_PDFdown"],       bLL);
    nnuis += getBGUncertainty(v2l["CR2l_Alphasup"],    v2l["CR2l_Alphasdown"],    bg2l, hist2l["CR2l_Alphasup"],    hist2l["CR2l_Alphasdown"],    bLL);
    nnuis += getBGUncertainty(v2l["CR2l_muRFup"],      v2l["CR2l_muRFdown"],      bg2l, hist2l["CR2l_muRFup"],      hist2l["CR2l_muRFdown"],      bLL);
    nnuis += getBGUncertainty(v2l["CR2l_JESup"],       v2l["CR2l_JESdown"],       bg2l, hist2l["CR2l_JESup"],       hist2l["CR2l_JESdown"],       bLL);
    nnuis += getBGUncertainty(v2l["CR2l_metRESup"],    v2l["CR2l_metRESdown"],    bg2l, hist2l["CR2l_metRESup"],    hist2l["CR2l_metRESdown"],    bLL);
    nnuis += getBGUncertainty(v1l["MC_Up"],      v1l["MC_Down"],      bg1l, hist1l["MC_Up"],      hist1l["MC_Down"],      bW);
    nnuis += getBGUncertainty(v1l["Wb_Up"],      v1l["Wb_Down"],      bg1l, hist1l["Wb_Up"],      hist1l["Wb_Down"],      bW);
    nnuis += getBGUncertainty(v1l["btag_HF_Up"], v1l["btag_HF_Down"], bg1l, hist1l["btag_HF_Up"], hist1l["btag_HF_Down"], bW);
    nnuis += getBGUncertainty(v1l["btag_LF_Up"], v1l["btag_LF_Down"], bg1l, hist1l["btag_LF_Up"], hist1l["btag_LF_Down"], bW);
    nnuis += getBGUncertainty(v1l["PDF_Up"],     v1l["PDF_Down"],     bg1l, hist1l["PDF_Up"],     hist1l["PDF_Down"],     bW);
    nnuis += getBGUncertainty(v1l["Q2_Up"],      v1l["Q2_Down"],      bg1l, hist1l["Q2_Up"],      hist1l["Q2_Down"],      bW);
    nnuis += getBGUncertainty(v1l["JES_Up"],     v1l["JES_Down"],     bg1l, hist1l["JES_Up"],     hist1l["JES_Down"],     bW);
    nnuis += getBGUncertainty(v1l["CRCont_Up"],  v1l["CRCont_Down"],  bg1l, hist1l["CRCont_Up"],  hist1l["CRCont_Down"],  bW);
    nnuis += getBGUncertainty(v1l["METRes_Up"],  v1l["METRes_Down"],  bg1l, hist1l["METRes_Up"],  hist1l["METRes_Down"],  bW);
    nnuis += getBGUncertainty(v1l["W_width_Up"], v1l["W_width_Down"], bg1l, hist1l["W_width_Up"], hist1l["W_width_Down"], bW);
    nnuis += getBGUncertainty(v1l["nu_pT_Up"],   v1l["nu_pT_Down"],   bg1l, hist1l["nu_pT_Up"],   hist1l["nu_pT_Down"],   bW);
    if(bg1ltop>0) v1ltop["tt1lyielderr"] = 2.; else v1ltop["tt1lyielderr"] = 1.;
    nnuis += getBGErrorRel(vZnunu["h_relUnc_PU"],           bgznunu, histZnunu["h_relUnc_PU"],           bTTZ);
    nnuis += getBGErrorRel(vZnunu["h_relUnc_lepSF"],        bgznunu, histZnunu["h_relUnc_lepSF"],        bTTZ);
    nnuis += getBGErrorRel(vZnunu["h_relUnc_JES"],          bgznunu, histZnunu["h_relUnc_JES"],          bTTZ);
    nnuis += getBGErrorRel(vZnunu["h_relUnc_BTagSF"],       bgznunu, histZnunu["h_relUnc_BTagSF"],       bTTZ);
    nnuis += getBGErrorRel(vZnunu["h_relUnc_ttbar_pt"],     bgznunu, histZnunu["h_relUnc_ttbar_pt"],     bTTZ);
    nnuis += getBGErrorRel(vZnunu["h_relUnc_th_PDF_total"], bgznunu, histZnunu["h_relUnc_th_PDF_total"], bTTZ);
    nnuis += getBGErrorRel(vZnunu["h_relUnc_th_Scale"],     bgznunu, histZnunu["h_relUnc_th_Scale"],     bTTZ);
  }//if(!nobgsyst)
  ...
  if(correlated){
    ...
    int nsubtract;
    nsubtract = -1 + (bg2l>0&&(v2l["CR2l_Bup_HF"]!=1||v2l["CR2l_Bdown_HF"]!=1)) + (bg1l>0&&(v1l["btag_HF_Up"]!=1||v1l["btag_HF_Down"]!=1)) + (bgznunu>0&&(vZnunu["h_relUnc_BTagSF"]!=1));
    if(nsubtract>0) nnuis -= nsubtract;
    nsubtract = -1 + (bg2l>0&&(v2l["CR2l_Bup_LF"]!=1||v2l["CR2l_Bdown_LF"]!=1)) + (bg1l>0&&(v1l["btag_LF_Up"]!=1||v1l["btag_LF_Down"]!=1));
    if(nsubtract>0) nnuis -= nsubtract;
    nsubtract = -1 + (bg2l>0&&(v2l["CR2l_LepEffup"]!=1||v2l["CR2l_LepEffdown"]!=1)) + (bgznunu>0&&(vZnunu["h_relUnc_lepSF"]!=1));
    if(nsubtract>0) nnuis -= nsubtract;
    nsubtract = -1 + (bg2l>0&&(v2l["CR2l_PDFup"]!=1||v2l["CR2l_PDFdown"]!=1)) + (bg1l>0&&(v1l["PDF_Up"]!=1||v1l["PDF_Down"]!=1)) + (bgznunu>0&&(vZnunu["h_relUnc_th_PDF_total"]!=1));
    if(nsubtract>0) nnuis -= nsubtract;
    nsubtract = -1 + (bg2l>0&&(v2l["CR2l_muRFup"]!=1||v2l["CR2l_muRFdown"]!=1)) + (bg1l>0&&(v1l["Q2_Up"]!=1||v1l["Q2_Down"]!=1)) + (bgznunu>0&&(vZnunu["h_relUnc_th_Scale"]!=1));
    if(nsubtract>0) nnuis -= nsubtract;
    nsubtract = -1 + (bg2l>0&&(v2l["CR2l_JESup"]!=1||v2l["CR2l_JESdown"]!=1)) + (bg1l>0&&(v1l["JES_Up"]!=1||v1l["JES_Down"]!=1)) + (bgznunu>0&&(vZnunu["h_relUnc_JES"]!=1));
    if(nsubtract>0) nnuis -= nsubtract;
    nsubtract = -1 + (bg2l>0&&(v2l["CR2l_metRESup"]!=1||v2l["CR2l_metRESdown"]!=1)) + (bg1l>0&&(v1l["METRes_Up"]!=1||v1l["METRes_Down"]!=1));
    if(nsubtract>0) nnuis -= nsubtract;
  }
  ...
  double lc = 1.026;//change in luminosity from last pixel calibration - DELETE THIS XXXYYYZZZ
  ...
  *fLogStream << "------------" << endl;
  ...
  if(!nosigsyst && sig    >0) addOneUnc(fLogStream, "SigStat",     sigerr,     -1, 0, b,     "lnN");
  if(!nobgsyst && bg2l   >0) addOneUnc(fLogStream, "Bg2lStat",    bg2lerr,    -1, 1, btt2l, "lnN");
  if(!nobgsyst && bg1l   >0) addOneUnc(fLogStream, "Bg1lStat",    bg1lerr,    -1, 2, bWst,  "lnN");
  if(!nobgsyst && bgznunu>0) addOneUnc(fLogStream, "BgZnunuStat", bgznunuerr, -1, 4, b,     "lnN");
  //if(!nobgsyst && bg1ltop>0) *fLogStream << "Bg1lTopStat" << b     << "     lnN -  -  -  "    << bg1ltoperr << "  -"          << endl;
  //general uncertainties
  if(!nobgsyst && bg1ltop>0) addOneUnc(fLogStream, "Bg1lTopSyst", v1ltop["tt1lyielderr"], -1, 3, b, "lnN");
  dnerr[0] = vSig["triggerr"]; dnerr[3] = vSig["triggerr"]; dnerr[4] = vSig["triggerr"];
  addCorrelatedUnc(fLogStream, "TrigSyst", dnerr, uperr, -1, "lnN");
  dnerr[0] = vSig["lumierr"]; dnerr[3] = vSig["lumierr"]; dnerr[4] = vSig["lumierr"];
  addCorrelatedUnc(fLogStream, "LumiSyst", dnerr, uperr, -1, "lnN");
  if(!nosigsyst&& sig    >0){
    //signal systematic uncertainties (or general - therefore add no "Sig" prefix)
    addOneUnc(fLogStream, "PUSyst",     vSig["SR_PUerr"],     -1, 0, -1, "lnN");
    addOneUnc(fLogStream, "BLFSyst",    vSig["SR_Bdown_LF"],     vSig["SR_Bup_LF"],     0, -1, "lnN");
    addOneUnc(fLogStream, "BHFSyst",    vSig["SR_Bdown_HF"],     vSig["SR_Bup_HF"],     0, -1, "lnN");
    addOneUnc(fLogStream, "JESSyst",    vSig["SR_JESdown"],      vSig["SR_JESup"],      0, -1, "lnN");
    addOneUnc(fLogStream, "ISRSyst",    vSig["SR_ISRdown"],      vSig["SR_ISRup"],      0, -1, "lnN");
    addOneUnc(fLogStream, "MuRFSyst",   vSig["SR_muRFdown"],     vSig["SR_muRFup"],     0, -1, "lnN");
    addOneUnc(fLogStream, "LEffSyst",   vSig["SR_LepEffdown"],   vSig["SR_LepEffup"],   0, -1, "lnN");
    addOneUnc(fLogStream, "LEffFSSyst", vSig["SR_LepEffFSdown"], vSig["SR_LepEffFSup"], 0, -1, "lnN");
    addOneUnc(fLogStream, "LVetoSyst",  vSig["SR_LEffVetoerr"],  -1,                    0,  b, "lnN");

  }
  if(!nobgsyst){
    //correlated
    if(correlated){
      dnerr[1] = v2l["CR2l_Bdown_HF"]; dnerr[2] = v1l["btag_HF_Down"]; dnerr[4] = vZnunu["h_relUnc_BTagSF"];
      uperr[1] = v2l["CR2l_Bup_HF"];   uperr[2] = v1l["btag_HF_Up"];
      addCorrelatedUnc(fLogStream, "BHFSystBg", dnerr, uperr, -1, "lnN");
      dnerr[1] = v2l["CR2l_Bdown_LF"]; dnerr[2] = v1l["btag_LF_Down"];
      uperr[1] = v2l["CR2l_Bup_LF"];   uperr[2] = v1l["btag_LF_Up"];
      addCorrelatedUnc(fLogStream, "BLFSystBg", dnerr, uperr, -1, "lnN");
      dnerr[1] = v2l["CR2l_LepEffdown"]; dnerr[4] = vZnunu["h_relUnc_lepSF"];
      uperr[1] = v2l["CR2l_LepEffup"];   
      addCorrelatedUnc(fLogStream, "LEffSystBg", dnerr, uperr, -1, "lnN");
      dnerr[1] = v2l["CR2l_PDFdown"]; dnerr[2] = v1l["PDF_Down"]; dnerr[4] = vZnunu["h_relUnc_th_PDF_total"];
      uperr[1] = v2l["CR2l_PDFup"];   uperr[2] = v1l["PDF_Up"];
      addCorrelatedUnc(fLogStream, "PDFSystBg", dnerr, uperr, -1, "lnN");
      dnerr[1] = v2l["CR2l_muRFdown"]; dnerr[2] = v1l["Q2_Down"]; dnerr[4] = vZnunu["h_relUnc_th_Scale"];
      uperr[1] = v2l["CR2l_muRFup"];   uperr[2] = v1l["Q2_Up"];
      addCorrelatedUnc(fLogStream, "QsqSystBg", dnerr, uperr, -1, "lnN");
      dnerr[1] = v2l["CR2l_JESdown"]; dnerr[2] = v1l["JES_Down"]; dnerr[4] = vZnunu["h_relUnc_JES"];
      uperr[1] = v2l["CR2l_JESup"];   uperr[2] = v1l["JES_Up"];
      addCorrelatedUnc(fLogStream, "JESSystBg", dnerr, uperr, -1, "lnN");
      dnerr[1] = v2l["CR2l_metRESdown"]; dnerr[2] = v1l["METRes_Down"];
      uperr[1] = v2l["CR2l_metRESup"];   uperr[2] = v1l["METRes_Up"];
      addCorrelatedUnc(fLogStream, "METSystBg", dnerr, uperr, -1, "lnN");
    }
    else {//uncorrelated
      //bg2l
      addOneUnc(fLogStream, "BHFSyst2l",  v2l["CR2l_Bdown_HF"],   v2l["CR2l_Bup_HF"],   1, -1, "lnN");
      addOneUnc(fLogStream, "BLFSyst2l",  v2l["CR2l_Bdown_LF"],   v2l["CR2l_Bup_LF"],   1, -1, "lnN");
      addOneUnc(fLogStream, "LEffSyst2l", v2l["CR2l_LepEffdown"], v2l["CR2l_LepEffup"], 1, -1, "lnN");
      addOneUnc(fLogStream, "PDFSyst2l",  v2l["CR2l_PDFdown"],    v2l["CR2l_PDFup"],    1, -1, "lnN");
      addOneUnc(fLogStream, "muRFSyst2l", v2l["CR2l_muRFdown"],   v2l["CR2l_muRFup"],   1, -1, "lnN");
      addOneUnc(fLogStream, "JESSyst2l",  v2l["CR2l_JESdown"],    v2l["CR2l_JESup"],    1, -1, "lnN");
      addOneUnc(fLogStream, "METSyst2l",  v2l["CR2l_metRESdown"], v2l["CR2l_metRESup"], 1, -1, "lnN");
      //bg1l
      addOneUnc(fLogStream, "BHFSyst1l",  v1l["btag_HF_Down"], v1l["btag_HF_Up"], 2, -1, "lnN");
      addOneUnc(fLogStream, "BLFSyst1l",  v1l["btag_LF_Down"], v1l["btag_LF_Up"], 2, -1, "lnN");
      addOneUnc(fLogStream, "PDFSyst1l",  v1l["PDF_Down"],     v1l["PDF_Up"],     2, -1, "lnN");
      addOneUnc(fLogStream, "muRFSyst1l", v1l["Q2_Down"],      v1l["Q2_Up"],      2, -1, "lnN");
      addOneUnc(fLogStream, "JESSysy1l",  v1l["JES_Down"],     v1l["JES_Up"],     2, -1, "lnN");
      addOneUnc(fLogStream, "METSyst1l",  v1l["METRes_Down"],  v1l["METRes_Up"],  2, -1, "lnN");
      //bgznunu
      addOneUnc(fLogStream, "BSFSystZ",  vZnunu["h_relUnc_BTagSF"],       -1, 4, -1, "lnN");
      addOneUnc(fLogStream, "LEffSystZ", vZnunu["h_relUnc_lepSF"],       -1, 4, -1, "lnN");
      addOneUnc(fLogStream, "JESSystZ",  vZnunu["h_relUnc_JES"],          -1, 4, -1, "lnN");
      addOneUnc(fLogStream, "PDFSystZ",  vZnunu["h_relUnc_th_PDF_total"], -1, 4,  b, "lnN");
      addOneUnc(fLogStream, "QsqSystZ",  vZnunu["h_relUnc_th_Scale"],     -1, 4,  b, "lnN");
    }
    //bg2l
    addOneUnc(fLogStream, "TPtSyst2l", v2l["CR2l_diNuSFdown"],    v2l["CR2l_diNuSFup"],    1, -1, "lnN");
    addOneUnc(fLogStream, "AsSyst2l",  v2l["CR2l_Alphasdown"],    v2l["CR2l_Alphasup"],    1, -1, "lnN");
    addOneUnc(fLogStream, "NJ3Syst2l", v2l["CR2l_nJetsSFK3down"], v2l["CR2l_nJetsSFK3up"], 1, -1, "lnN");
    addOneUnc(fLogStream, "NJ4Syst2l", v2l["CR2l_nJetsSFK4down"], v2l["CR2l_nJetsSFK4up"], 1, -1, "lnN");
    //bg1l
    addOneUnc(fLogStream, "MCSyst1l",     v1l["MC_Down"],      v1l["MC_Up"],      1,  b, "lnN");
    addOneUnc(fLogStream, "WbxsSyst1l",   v1l["Wb_Down"],      v1l["Wb_Up"],      1, -1, "lnN");
    addOneUnc(fLogStream, "WwidthSyst1l", v1l["W_width_Down"], v1l["W_width_Up"], 1, -1, "lnN");
    addOneUnc(fLogStream, "ContSyst1l",   v1l["CRCont_Down"],  v1l["CRCont_Up"],  1, -1, "lnN");
    addOneUnc(fLogStream, "NuPtSyst1l",   v1l["nu_pT_Down"],   v1l["nu_pT_Up"],   1, -1, "lnN");
    //bgznunu
    addOneUnc(fLogStream, "TPtSystZ", vZnunu["h_relUnc_ttbar_pt"], -1, 4,  b, "lnN");
    addOneUnc(fLogStream, "PUSystZ",  vZnunu["h_relUnc_PU"],       -1, 4, -1, "lnN");
  }
  *fLogStream << endl;
  ...
  //do this extra
  //comment out for now - code crashes in case the file does not exist yet - as not essential - fix later
...
int getBGUncertainty(double &errup, double &errdown, double origyield, TH1D *hup, TH1D *hdown, int bin){
  ...
  // downshape = origyield + downvariation --> want 1 + downvariation / origyield, where downvariation < 0
  if(origyield<0){ errup = 1; errdown = 1; return 0; }
  //cout << hup->GetName() << endl;
  //cout << hdown->GetName() << endl;
  errup = hup->GetBinContent(bin) / origyield;
  if(errup<0) errup = 0.0001;
  else if (errup>2) errup = 2;
  errdown = hdown->GetBinContent(bin) / origyield;
...
bool loadDataBGHistos(bool fakedata){
  ...
  hist2l["CR2lyield"];
  hist2l["CR2l_Bup_HF"];
  hist2l["CR2l_Bdown_HF"];
  hist2l["CR2l_Bup_LF"];
  hist2l["CR2l_Bdown_LF"];
  hist2l["CR2l_LepEffup"];
  hist2l["CR2l_LepEffdown"];
  hist2l["CR2l_diNuSFup"];
  hist2l["CR2l_diNuSFdown"];
  hist2l["CR2l_nJetsSFK3up"];
  hist2l["CR2l_nJetsSFK3down"];
  hist2l["CR2l_nJetsSFK4up"];
  hist2l["CR2l_nJetsSFK4down"];
  hist2l["CR2l_PDFup"];
  hist2l["CR2l_PDFdown"];
  hist2l["CR2l_Alphasup"];
  hist2l["CR2l_Alphasdown"];
  hist2l["CR2l_muRFup"];
  hist2l["CR2l_muRFdown"];
  hist2l["CR2l_JESup"];
  hist2l["CR2l_JESdown"];
  ...
  histZnunu["h_signal_bins_rare"];
  histZnunu["h_relUnc_PU"];
  histZnunu["h_relUnc_lepSF"];
  histZnunu["h_relUnc_JES"];
  histZnunu["h_relUnc_BTagSF"];
  histZnunu["h_relUnc_ttbar_pt"];
  histZnunu["h_relUnc_th_PDF_total"];
  histZnunu["h_relUnc_th_Scale"];
  ...
  histData["Data"];
  if(fakedata) { histData["Data"] = (TH1D*)hist2l["CR2lyield"]->Clone("Data"); }
  else {
...
void addCorrelatedUnc(std::ostringstream *fLogStream, string name, double *d, double *u, int bin, string unctype){
 if(unctype.find(string("gmN")) != string::npos){
	for(unsigned int i = 0; i<maxnprocess; ++i){
 		if(u[i]<0) return;//all defined u's have to be >=0
	}
 }
 if(!checkIfPos(d)) return;
...
void addOneUnc(std::ostringstream *fLogStream, string name, double d, double u, int process, int bin, string unctype){
  ...
  if(d==1&&u==1) return;
  if(d==1&&u<0) return;
  if(unctype.find(string("gmN")) != string::npos && u<0) return;
  *fLogStream << " " << setw(15) << name;
  if(bin>0) *fLogStream << bin;
...
int minstopmass(TString signaltype){
  if(signaltype.Contains("T2tt")) return 100;
  if(signaltype.Contains("T2tb")) return 200;
  if(signaltype.Contains("T2bW")) return 150;
  return -1;
}
int maxstopmass(TString signaltype){
  if(signaltype.Contains("T2tt")) return 950;
  if(signaltype.Contains("T2tb")) return 1000;
  if(signaltype.Contains("T2bW")) return 950;
  return -1;
}
...
int maxlspmass(TString signaltype){
  if(signaltype.Contains("T2tt")) return 450;
  if(signaltype.Contains("T2tb")) return 450;
  if(signaltype.Contains("T2bW")) return 375;
  return -1;
}
...
int checkbin(int analysis, int bin, double stop, double lsp, bool dropsigcont){
  ...
  int bTTZ = GetTTZBin(b);
  int bW = b;
  if(bLL>hist2l["CR2lyield"]->GetNbinsX()) return -1;
  if(bW>hist1l["CR1lyield"]->GetNbinsX()) return -1;
  if(bW>hist1ltop["tt1lyield"]->GetNbinsX()) return -1;
  if(bTTZ>histZnunu["h_signal_bins_rare"]->GetNbinsX()) return -1;
  if(b>histData["Data"]->GetNbinsX()) return -1;
  ...
  if(sig<=0) return -1;
  if(hist2l["CR2lyield"]->GetBinContent(bLL)<0) return -1;
  if(hist1l["CR1lyield"]->GetBinContent(bW)<0) return -1;
  if(hist1ltop["tt1lyield"]->GetBinContent(bW)<0) return -1;
  if(histZnunu["h_signal_bins_rare"]->GetBinContent(bTTZ)<0) return -1;
  if(histData["Data"]->GetBinContent(b)<0) return -1;
...
void UpdatePlottingHisto(int analysis, TString signalname, int b, int data, double sig, double sigerr, map<string, double> vSig, double bg2l, double bg2lerr, map<string, double> v2l, double bg1l, double bg1lerr, map<string, double> v1l, double bg1ltop, double bg1ltoperr, map<string, double> v1ltop, double bgznunu, double bgznunuerr, map<string, double> vZnunu, bool nosigsyst, bool nobgsyst, bool dropsigcont, bool fakedata){
  ...
  if(     signalname== "T2tt_750_50") addthissignal = true;
  else if(signalname=="T2tt_600_250") addthissignal = true;
  else if(signalname=="T2tt_500_100") addthissignal = true;
  else if(signalname=="T2tt_300_200") addthissignal = true;
  else if(signalname== "T2bW_600_50") addthissignal = true;
  else if(signalname=="T2bW_500_200") addthissignal = true;
  else if(signalname=="T2bW_300_150") addthissignal = true;
  else if(signalname== "T2tt_700_50") addthissignal = true;
  else if(signalname== "T2tt_600_50") addthissignal = true;
  else if(signalname=="T2tt_500_200") addthissignal = true;
  else if(signalname=="T2tt_300_150") addthissignal = true;
  else if(signalname=="T2bW_600_200") addthissignal = true;
  else if(signalname== "T2bW_700_50") addthissignal = true;
  else if(signalname== "T2tb_600_50") addthissignal = true;
  else if(signalname=="T2tb_500_200") addthissignal = true;
  else if(signalname=="T2tb_300_150") addthissignal = true;
  else if(signalname=="T2tb_600_200") addthissignal = true;
  else if(signalname== "T2tb_700_50") addthissignal = true;
  else if(signalname== "T2tt_600_50") addthissignal = true;
  ...
  rpt_znunu->SetBinError(b,bgznunu*sqrt(add2(bgznunuerr,-1) + add2(vZnunu["h_relUnc_PU"],-1) + add2(vZnunu["h_relUnc_lepSF"],-1) + add2(vZnunu["h_relUnc_JES"], -1) + add2(vZnunu["h_relUnc_BTagSF"],-1) + add2(vZnunu["h_relUnc_ttbar_pt"],-1) + add2(vZnunu["h_relUnc_th_PDF_total"],-1) + add2(vZnunu["h_relUnc_th_Scale"],-1) + add2(vSig["triggerr"],-1) + add2(vSig["lumierr"],-1) ) );
  rpt_sig->SetBinContent(b,sig);
  rpt_sig->SetBinError(b,sig*sqrt(add2(sigerr,-1) + add2(vSig["SR_Bup_HF"],vSig["SR_Bdown_HF"]) + add2(vSig["SR_Bup_LF"],vSig["SR_Bdown_LF"]) + add2(vSig["SR_JESup"],vSig["SR_JESdown"]) + add2(vSig["SR_muRFup"], vSig["SR_muRFdown"]) + add2(vSig["SR_ISRup"],vSig["SR_ISRdown"]) + add2(vSig["SR_LepEffup"], vSig["SR_LepEffdown"]) + add2(vSig["SR_LepEffFSup"],vSig["SR_LepEffFSdown"]) + add2(vSig["triggerr"],-1) + add2(vSig["lumierr"],-1) + add2(vSig["SR_PUerr"],-1) + add2(vSig["SR_LEffVetoerr"],-1) ) );
  updatefile->cd();
  ...
  /*
  if(!udata) rpt_Data->Delete();
  if(!uLL  ) rpt_LLest->Delete();
  if(!u0b  ) rpt_0best->Delete();
  if(!utt1l) rpt_tt1l->Delete();
  if(!uZ   ) rpt_znunu->Delete();
  if(!usig ) rpt_sig->Delete();
  */
  delete updatefile;
  return;
}
