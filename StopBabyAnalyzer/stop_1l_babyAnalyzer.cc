...
namespace stop_1l {
	...
	const double &MT2W() { return babyAnalyzer.MT2W(); }
	const double &MT2W_lep2() { return babyAnalyzer.MT2W_lep2(); }
	...
	const double &topness() { return babyAnalyzer.topness(); }
	const double &Topness_lep2() { return babyAnalyzer.Topness_lep2(); }
	const double &TopnessMod_lep1() { return babyAnalyzer.TopnessMod_lep1(); }
	const double &TopnessMod_lep2() { return babyAnalyzer.TopnessMod_lep2(); }
	...
	const float &Mlb() { return babyAnalyzer.Mlb(); }
	const float &Mlb_lep2() { return babyAnalyzer.Mlb_lep2(); }
	...
	const int &lep1_is_fromw() { return babyAnalyzer.lep1_is_fromw(); }
	...
	const float &lep1_pfiso04() { return babyAnalyzer.lep1_pfiso04(); }
	const float &lep1_pfiso03() { return babyAnalyzer.lep1_pfiso03(); }
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep1_pfp4() { return babyAnalyzer.lep1_pfp4(); }
	...
	const int &lep2_is_fromw() { return babyAnalyzer.lep2_is_fromw(); }
	...
	const float &lep2_pfiso04() { return babyAnalyzer.lep2_pfiso04(); }
	const float &lep2_pfiso03() { return babyAnalyzer.lep2_pfiso03(); }
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &lep2_pfp4() { return babyAnalyzer.lep2_pfp4(); }
	...
	const vector<float> &ak4pfjets_pu_id() { return babyAnalyzer.ak4pfjets_pu_id(); }
