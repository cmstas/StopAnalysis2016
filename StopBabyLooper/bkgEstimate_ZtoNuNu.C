...
int bkgEstimate_ZtoNuNu(){
  ...
  for(int iBkgEst=0; iBkgEst<(int)v_bkgEst.size(); iBkgEst++){
    ...
    root_fileName += "__bkgEst_ZtoNuNu__histos.root";
    ...
    texFile += hNameBase;
    texFile += "__bkgEst_ZtoNuNu__resultsTable.tex";
    ...
    uncFileName += "__bkgEst_ZtoNuNu__uncertaintyTable__byCategory.tex";
    ...
    uncFileSummaryName += "__bkgEst_ZtoNuNu__uncertaintyTable__summary.tex";
    ...
    uncFileSummaryV2Name += "__bkgEst_ZtoNuNu__uncertaintyTable__summary__byCategory.tex";
