...
int tableMaker_summedInputs( std::string f_input_dir="Output/Histos/", std::string f_out_name="Output/Tables/yields_summedInputs.tex", bool useZeroedAMCNLO=true ){
  ...
  //
  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 1; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$M_{lb}<175$,~$250<MET<350$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 2; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$M_{lb}<175$,~$350<MET<450$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 3; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$M_{lb}<175$,~$450<MET<550$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 4; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$M_{lb}<175$,~$MET>550$";
  catList.push_back( cat );
  tableList.push_back( catList );

  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 5; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$M_{lb}\\ge175$,~$250<MET<350$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 6; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$M_{lb}\\ge175$,~$350<MET<450$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 7; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$M_{lb}\\ge175$,~$450<MET<550$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 8; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$M_{lb}\\ge175$,~$MET>550$";
  catList.push_back( cat );
  tableList.push_back( catList );
  ...
  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 18; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$M_{lb}<175$,~$250<MET<350$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 19; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$M_{lb}<175$,~$350<MET<450$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 20; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$M_{lb}<175$,~$MET>450$";
  catList.push_back( cat );
  
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 21; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$M_{lb}\\ge175$,~$250<MET<400$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 22; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$M_{lb}\\ge175$,~$MET>400$";
  catList.push_back( cat );
  tableList.push_back( catList );
  
  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 23; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$M_{lb}<175$,~$250<MET<350$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 24; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$M_{lb}<175$,~$350<MET<450$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 25; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$M_{lb}<175$,~$450<MET<600$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 26; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$M_{lb}<175$,~$MET>600$";
  catList.push_back( cat );
  tableList.push_back( catList );

  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 27; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$M_{lb}\\ge175$,~$250<MET<400$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 28; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$M_{lb}\\ge175$,~$400<MET<650$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_mlb_v1"; cat.binNumber = 29; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$M_{lb}\\ge175$,~$MET>650$";
  catList.push_back( cat );
  tableList.push_back( catList );
  ...
  //
  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 1; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$leadBJetPt<200$,~$250<MET<350$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 2; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$leadBJetPt<200$,~$350<MET<450$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 3; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$leadBJetPt<200$,~$450<MET<550$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 4; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$leadBJetPt<200$,~$MET>550$";
  catList.push_back( cat );
  tableList.push_back( catList );

  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 5; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$leadBJetPt\\ge200$,~$250<MET<350$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 6; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$leadBJetPt\\ge200$,~$350<MET<450$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 7; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$leadBJetPt\\ge200$,~$450<MET<550$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 8; cat.tex = "$<4$jets,~modTopness$\\ge7.5$,~$leadBJetPt\\ge200$,~$MET>550$";
  catList.push_back( cat );
  tableList.push_back( catList );
  ...
  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 18; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$leadBJetPt<200$,~$250<MET<350$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 19; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$leadBJetPt<200$,~$350<MET<450$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 20; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$leadBJetPt<200$,~$MET>450$";
  catList.push_back( cat );
  
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 21; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$leadBJetPt\\ge200$,~$250<MET<400$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 22; cat.tex = "$\\ge4$jets,~$0.0<$modTopness$<7.5$,~$leadBJetPt\\ge200$,~$MET>400$";
  catList.push_back( cat );
  tableList.push_back( catList );

  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 23; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$leadBJetPt<200$,~$250<MET<350$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 24; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$leadBJetPt<200$,~$350<MET<450$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 25; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$leadBJetPt<200$,~$450<MET<600$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 26; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$leadBJetPt<200$,~$MET>600$";
  catList.push_back( cat );
  tableList.push_back( catList );

  catList.clear();
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 27; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$leadBJetPt\\ge200$,~$250<MET<400$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 28; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$leadBJetPt\\ge200$,~$400<MET<650$";
  catList.push_back( cat );
  cat.histName = "h_yields_SR_dev_ext30fb_bJetPt_v1"; cat.binNumber = 29; cat.tex = "$\\ge4$jets,~modTopness$\\ge7.5$,~$leadBJetPt\\ge200$,~$MET>650$";
  catList.push_back( cat );
  tableList.push_back( catList );
  ...
  for(int iRegion=0; iRegion<(int)regionList.size(); iRegion++){
	...
	TString hName_temp = tableList[iTable][0].histName;
	...
	int maxRows = 1;
	for(int iCat=0; iCat<(int)tableList[iTable].size(); iCat++){
	  std::string cat_title = tableList[iTable][iCat].tex;
	  int nCommas = 0;
	...
	for(int iSig=0; iSig<(int)sigList.size(); iSig++){
	  ...
	  for(int iMassPt=0; iMassPt<(int)massPtList.size(); iMassPt++){
	    ...
	    for(int iCat=0; iCat<(int)tableList[iTable].size(); iCat++){
	      ...
	      std::string h_name = tableList[iTable][iCat].histName;
	      h_name += "__";
	      ...
	      int binZ = tableList[iTable][iCat].binNumber;
	...
	for(int iBkg=0; iBkg<(int)bkgList.size(); iBkg++){
	  ...
	  for(int iCat=0; iCat<(int)tableList[iTable].size(); iCat++){
	    ...
	    yield = h_yield_bkg->GetBinContent( tableList[iTable][iCat].binNumber );
	    error = h_yield_bkg->GetBinError( tableList[iTable][iCat].binNumber );
	...
	for(int iCat=0; iCat<(int)tableList[iTable].size(); iCat++){
	  ...
	  yield = h_yield_data->GetBinContent( tableList[iTable][iCat].binNumber );
	  error = sqrt(yield);
