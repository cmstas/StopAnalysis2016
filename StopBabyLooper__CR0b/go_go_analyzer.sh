...
echo ""
root -l -b -q head.C zeroOutNegativeYields.C++'("Histos/Nominal/")' >& Output/Log/zeroOutNegtiveYields.log
...
echo ""
root -l -b -q head.C calcErrors.C++ >& Histos/Nominal/calcErrors.log
