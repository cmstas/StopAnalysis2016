...
int bkgEstimate_diLepton_newBinning(){
  ...
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee2jets_ge6p4modTop_250to350met ) ); // 1
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee2jets_ge6p4modTop_350to450met ) ); // 2
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee2jets_ge6p4modTop_450toInfmet ) ); // 3
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee3jets_ge200mt2w_250to350met) );    // 4
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee3jets_ge200mt2w_350to450met) );    // 5
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee3jets_ge200mt2w_450to550met) );    // 6
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee3jets_ge200mt2w_550toInfmet ) );   // 7
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_lt200mt2w_250to350met ) );   // 8
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_lt200mt2w_350to450met ) );   // 9
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_lt200mt2w_450toInfmet) );    // 10
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_ge200mt2w_250to350met ) );   // 11
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_ge200mt2w_350to450met ) );   // 12
  ...
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge5jets_compM_250to350met ) );       // 16
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge5jets_compM_350to450met ) );       // 17
  sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge5jets_compM_450toInfmet) );        // 18
  ...
  cat_metLabels.push_back("$250-350$"); cat_jetLabels.push_back("");
  cat_metLabels.push_back("$350-450$"); cat_jetLabels.push_back("$\\ge5$j,~compDM");
  cat_metLabels.push_back("$>450$"); cat_jetLabels.push_back("");
  ...
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee2jets_ge6p4modTop_250to350met ) ); // 1
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee2jets_ge6p4modTop_350to450met ) ); // 2
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee2jets_ge6p4modTop_450toInfmet ) ); // 3
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee3jets_ge200mt2w_250to350met ) );   // 4
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee3jets_ge200mt2w_350to450met ) );   // 5
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee3jets_ge200mt2w_450toInfmet ) );   // 6 - extrapolate
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ee3jets_ge200mt2w_450toInfmet ) );   // 7 - extrapolate
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_lt200mt2w_250to350met ) );   // 8
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_lt200mt2w_350to450met ) );   // 9
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_lt200mt2w_450toInfmet ) );   // 10
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_ge200mt2w_250to350met ) );   // 11
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge4jets_ge200mt2w_350to450met ) );   // 12
  ...
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge5jets_compM_250to350met ) );       // 16
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge5jets_compM_350to450met ) );       // 17
  cr2sr_cats.push_back( categoryInfo::categoryUtil( categoryInfo::k_ge5jets_compM_450toInfmet ) );       // 18
  ...
  //
  TFile  *f_out = new TFile(outDir+"h__bkgEstimate_diLepton__newBins.root", "recreate");
