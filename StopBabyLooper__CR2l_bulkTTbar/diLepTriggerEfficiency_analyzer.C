...
int diLepTriggerEfficiency_analyzer(){
  ...
  // Get Data File
  TFile *f_in = new TFile( "Histos/Nominal/h__data_diLepton_2016B_25ns.root", "read" );

  // Open Output File
  TFile *f_out = new TFile( "Histos/Nominal/h__diLeptonTriggerEfficiencies.root", "update" );
