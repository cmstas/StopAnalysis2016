...
int mergeStopBabies( std::string f_input_dir, std::string f_output_dir, bool use_zeroed_samp=true ){
  ...
  addSet.second.push_back( mergeUtil(sampleInfo::k_WJetsToLNu_HT100To200_madgraph_pythia8,false,use_rescaled_samp) );
  addSet.second.push_back( mergeUtil(sampleInfo::k_WJetsToLNu_HT200To400_madgraph_pythia8,false,use_rescaled_samp) );
  ...
  addSet.second.push_back( mergeUtil(sampleInfo::k_WJetsToLNu_HT800To1200_madgraph_pythia8) );
