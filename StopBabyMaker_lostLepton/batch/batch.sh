...
copy_dir=/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies__lostLeptonBabies__20150702
...
if [ ! -e $HOME/forCondor_stopBabyMaker_lostLeptons_v2.tar.gz ]; then echo "Run . copy.sh first!"; return 1; fi


#Set directory with the location of the tarball with code
tar_file=$HOME/forCondor_stopBabyMaker_lostLeptons_v2.tar.gz
