...
ls
tar xzfv forCondor_stopBabyMaker_lostLeptons_v2.tar.gz
echo "LS to check that tarball was unpacked: "
ls
cd forCondor_stopBabyMaker_lostLeptons_v2/CMSSW_7_2_0/src
...
cd StopAnalysis/StopBabyMaker_lostLepton/
make clean
make
