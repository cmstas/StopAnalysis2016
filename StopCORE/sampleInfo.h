...
namespace sampleInfo{
  ...
  //
  const std::string baby_inputDir_nominal  = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies__CMS3_V070411__BabyMaker_V0704X_v9__20160127/merged_files/";
  const std::string baby_inputDir_jesUp    = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies_JECup__CMS3_V070411__BabyMaker_V0704X_v9__20160127/merged_files/";
  const std::string baby_inputDir_jesDn    = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies_JECdown__CMS3_V070411__BabyMaker_V0704X_v9__20160127/merged_files/";
