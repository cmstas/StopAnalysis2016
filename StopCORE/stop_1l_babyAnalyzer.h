...
// makeCMS3ClassFiles("/nfs-7/userdata/haweber/tupler_babies/merged/Stop_1l/v21_photons/output/data_singlephoton_Run2016F_23Sep2016_v1.root", "t", "stop_1l_babyAnalyzer", "stop_1l", "babyAnalyzer")
// Plus a little manual tinkering for compatibility with older parts of this code
...
class stop_1l_babyAnalyzer {
 ...
 protected: 
  ...
  float    ph_MT2_l_l_;
  TBranch *ph_MT2_l_l_branch;
  bool     ph_MT2_l_l_isLoaded;
