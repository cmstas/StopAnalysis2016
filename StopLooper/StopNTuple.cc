...
void StopNTuple::Init(TTree *tree) {
...
void StopNTuple::GetEntry(unsigned int idx) 
...
void StopNTuple::LoadAllBranches() 
	// load all branches
{
	if (run_branch != 0) run();
	if (ls_branch != 0) ls();
	...
	const unsigned int &StopNTuple::run()
	{
		if (not run_isLoaded) {
			if (run_branch != 0) {
	...
	const unsigned int &StopNTuple::ls()
	{
		if (not ls_isLoaded) {
			if (ls_branch != 0) {
	...
	const unsigned int &StopNTuple::evt()
	{
		if (not evt_isLoaded) {
			if (evt_branch != 0) {
	...
	const int &StopNTuple::firstGoodVtxIdx()
	{
	...
	const int &StopNTuple::firstVtx_isfake()
	{
	...
	const float &StopNTuple::firstVtx_ndof()
	{
	...
	const float &StopNTuple::firstVtx_posRho()
	{
	...
	const float &StopNTuple::firstVtx_posZ()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::firstVtx_posp4()
	{
	...
	const float &StopNTuple::pfmet_phi()
	{
	...
	const float &StopNTuple::calomet()
	{
	...
	const float &StopNTuple::calomet_phi()
	{
	...
	const float &StopNTuple::filt_cscbeamhalo()
	{
	...
	const float &StopNTuple::filt_ecallaser()
	{
	...
	const float &StopNTuple::filt_ecaltp()
	{
	...
	const float &StopNTuple::filt_eebadsc()
	{
	...
	const float &StopNTuple::filt_goodvtx()
	{
	...
	const float &StopNTuple::filt_badevents()
	{
	...
	const float &StopNTuple::filt_hbhenoise()
	{
	...
	const float &StopNTuple::filt_hcallaser()
	{
	...
	const float &StopNTuple::filt_met()
	{
	...
	const float &StopNTuple::filt_trkfail()
	{
	...
	const float &StopNTuple::filt_trkPOG()
	{
	...
	const float &StopNTuple::filt_trkPOG_tmc()
	{
	...
	const float &StopNTuple::filt_trkPOG_tms()
	{
	...
	const float &StopNTuple::filt_eff()
	{
	...
	const float &StopNTuple::scale1fb()
	{
	...
	const float &StopNTuple::xsec_uncert()
	{
	...
	const float &StopNTuple::kfactor()
	{
	...
	const float &StopNTuple::pu_ntrue()
	{
	...
	const int &StopNTuple::ngoodleps()
	{
	...
	const int &StopNTuple::nlooseleps()
	{
	...
	const int &StopNTuple::nvetoleps()
	{
	...
	const string &StopNTuple::dataset()
	{
	...
	const string &StopNTuple::filename()
	{
	...
	const string &StopNTuple::cms3tag()
	{
	...
	const unsigned int &StopNTuple::nEvents()
	{
	...
	const unsigned int &StopNTuple::nEvents_goodvtx()
	{
	...
	const unsigned int &StopNTuple::nEvents_MET30()
	{
	...
	const unsigned int &StopNTuple::nEvents_1goodlep()
	{
	...
	const unsigned int &StopNTuple::nEvents_2goodjets()
	{
	...
	const int &StopNTuple::genlepsfromtop()
	{
	...
	const int &StopNTuple::genLepsHardProcess()
	{
	...
	const int &StopNTuple::genNusHardProcess()
	{
	...
	const int &StopNTuple::isZtoNuNu()
	{
	...
	const int &StopNTuple::is1lepFromW()
	{
	...
	const int &StopNTuple::is1lepFromTop()
	{
	...
	const float &StopNTuple::MT2W_lep2()
	{
	...
	const float &StopNTuple::mindphi_met_j1_j2()
	{
	...
	const float &StopNTuple::mt_met_lep()
	{
	...
	const float &StopNTuple::mt_met_lep2()
	{
	...
	const float &StopNTuple::dR_lep_leadb()
	{
	...
	const float &StopNTuple::dR_lep2_leadb()
	{
	...
	const float &StopNTuple::hadronic_top_chi2()
	{
	...
	const float &StopNTuple::dphi_Wlep()
	{
	...
	const float &StopNTuple::MET_over_sqrtHT()
	{
	...
	const float &StopNTuple::ak4pfjets_rho()
	{
	...
	const float &StopNTuple::pdf_up_weight()
	{
	...
	const float &StopNTuple::pdf_down_weight()
	{
	...
	const vector<string> &StopNTuple::genweightsID()
	{
	...
	const vector<float> &StopNTuple::genweights()
	{
	...
	const float &StopNTuple::weight_btagsf()
	{
	...
	const float &StopNTuple::weight_btagsf_heavy_UP()
	{
	...
	const float &StopNTuple::weight_btagsf_light_UP()
	{
	...
	const float &StopNTuple::weight_btagsf_heavy_DN()
	{
	...
	const float &StopNTuple::weight_btagsf_light_DN()
	{
	...
	const float &StopNTuple::weight_ISR()
	{
	...
	const float &StopNTuple::weight_ISRup()
	{
	...
	const float &StopNTuple::weight_ISRdown()
	{
	...
	const float &StopNTuple::weight_PU()
	{
	...
	const float &StopNTuple::weight_PUup()
	{
	...
	const float &StopNTuple::weight_PUdown()
	{
	...
	const float &StopNTuple::hardgenpt()
	{
	...
	const vector<string> &StopNTuple::sparms_names()
	{
	...
	const float &StopNTuple::sparms_filterEfficiency()
	{
	...
	const float &StopNTuple::sparms_pdfScale()
	{
	...
	const float &StopNTuple::sparms_pdfWeight1()
	{
	...
	const float &StopNTuple::sparms_pdfWeight2()
	{
	...
	const float &StopNTuple::sparms_weight()
	{
	...
	const float &StopNTuple::sparms_xsec()
	{
	...
	const vector<float> &StopNTuple::sparms_values()
	{
	...
	const int &StopNTuple::sparms_subProcessId()
	{
	...
	const float &StopNTuple::mass_lsp()
	{
	...
	const float &StopNTuple::mass_chargino()
	{
	...
	const float &StopNTuple::mass_stop()
	{
	...
	const float &StopNTuple::genmet_phi()
	{
	...
	const bool &	StopNTuple::PassTrackVeto()
	{
	...
	const bool &	StopNTuple::PassTrackVeto_v2()
	{
	...
	const bool &	StopNTuple::PassTrackVeto_v3()
	{
	...
	const bool &	StopNTuple::PassTauVeto()
	{
	...
	const float &StopNTuple::EA_all_rho()
	{
	...
	const float &StopNTuple::EA_allcalo_rho()
	{
	...
	const float &StopNTuple::EA_centralcalo_rho()
	{
	...
	const float &StopNTuple::EA_centralchargedpileup_rho()
	{
	...
	const float &StopNTuple::EA_centralneutral_rho()
	{
	...
	const float &StopNTuple::topness()
	{
	...
	const float &StopNTuple::topness_lep2()
	{
	...
	const float &StopNTuple::topnessMod()
	{
	...
	const float &StopNTuple::topnessMod_lep2()
	{
	...
	const float &StopNTuple::MT2_lb_b()
	{
	...
	const float &StopNTuple::MT2_lb_b_lep2()
	{
	...
	const float &StopNTuple::MT2_lb_b_mass()
	{
	...
	const float &StopNTuple::MT2_lb_b_mass_lep2()
	{
	...
	const float &StopNTuple::MT2_lb_bqq()
	{
	...
	const float &StopNTuple::MT2_lb_bqq_lep2()
	{
	...
	const float &StopNTuple::MT2_lb_bqq_mass()
	{
	...
	const float &StopNTuple::MT2_lb_bqq_mass_lep2()
	{
	...
	const float &StopNTuple::Mlb_closestb()
	{
	...
	const float &StopNTuple::Mlb_lead_bdiscr()
	{
	...
	const float &StopNTuple::Mlb_closestb_lep2()
	{
	...
	const float &StopNTuple::Mlb_lead_bdiscr_lep2()
	{
	...
	const float &StopNTuple::Mjjj_lep2()
	{
	...
	const int &StopNTuple::HLT_SingleEl()
	{
	...
	const int &StopNTuple::HLT_SingleMu()
	{
	...
	const int &StopNTuple::HLT_MET170()
	{
	...
	const int &StopNTuple::HLT_MET120Btag()
	{
	...
	const int &StopNTuple::HLT_MET120Mu5()
	{
	...
	const int &StopNTuple::HLT_HT350MET120()
	{
	...
	const int &StopNTuple::HLT_DiEl_17_12()
	{
	...
	const int &StopNTuple::HLT_Mu8El17()
	{
	...
	const int &StopNTuple::HLT_Mu8El23()
	{
	...
	const int &StopNTuple::HLT_Mu17El12()
	{
	...
	const int &StopNTuple::HLT_Mu23El12()
	{
	...
	const int &StopNTuple::HLT_SingleEl23()
	{
	...
	const int &StopNTuple::HLT_SingleEl27()
	{
	...
	const int &StopNTuple::HLT_SingleEl27Tight()
	{
	...
	const int &StopNTuple::HLT_SingleElTight()
	{
	...
	const int &StopNTuple::HLT_SingleElHT200()
	{
	...
	const int &StopNTuple::HLT_SingleMuNoEta()
	{
	...
	const int &StopNTuple::HLT_SingleMuNoIso()
	{
	...
	const int &StopNTuple::HLT_SingleMuNoIsoNoEta()
	{
	...
	const int &StopNTuple::HLT_Mu6HT200MET100()
	{
	...
	const int &StopNTuple::HLT_HT350MET100()
	{
	...
	const int &StopNTuple::HLT_SingleMu17()
	{
	...
	const int &StopNTuple::HLT_SingleMu18()
	{
	...
	const int &StopNTuple::HLT_SingleMu20()
	{
	...
	const int &StopNTuple::HLT_SingleMu24()
	{
	...
	const int &StopNTuple::HLT_MonoCentPFJet80_METNoMu90_MHTNoMu90_IDTight()
	{
	...
	const int &StopNTuple::HLT_MET90_MHT90_IDTight()
	{
	...
	const int &StopNTuple::HLT_METNoMu90_NoiseCleaned_MHTNoMu90_IDTight()
	{
	...
	const int &StopNTuple::HLT_Photon90_CaloIdL_PFHT500()
	{
	...
	const int &StopNTuple::HLT_Photon22_R9Id90_HE10_IsoM()
	{
	...
	const int &StopNTuple::HLT_Photon30_R9Id90_HE10_IsoM()
	{
	...
	const int &StopNTuple::HLT_Photon36_R9Id90_HE10_IsoM()
	{
	...
	const int &StopNTuple::HLT_Photon50_R9Id90_HE10_IsoM()
	{
	...
	const int &StopNTuple::HLT_Photon75_R9Id90_HE10_IsoM()
	{
	...
	const int &StopNTuple::HLT_Photon90_R9Id90_HE10_IsoM()
	{
	...
	const int &StopNTuple::HLT_Photon120_R9Id90_HE10_IsoM()
	{
	...
	const int &StopNTuple::HLT_Photon165_R9Id90_HE10_IsoM()
	{
	...
	const int &StopNTuple::HLT_Photon175()
	{
	...
	const int &StopNTuple::HLT_Photon165_HE10()
	{
	...
	const float &StopNTuple::btag_sf()
	{
	...
	const float &StopNTuple::HLT_SingleEl_eff()
	{
	...
	const float &StopNTuple::HLT_SingleMu_eff()
	{
	...
	const int &StopNTuple::ph_selectedidx()
	{
	...
	const int &StopNTuple::ph_ngoodjets()
	{
	...
	const int &StopNTuple::ph_ngoodbtags()
	{
	...
	const float &StopNTuple::ph_met_phi()
	{
	...
	const float &StopNTuple::ph_htssm()
	{
	...
	const float &StopNTuple::ph_htosm()
	{
	...
	const float &StopNTuple::ph_htratiom()
	{
	...
	const float &StopNTuple::ph_mt_met_lep()
	{
	...
	const float &StopNTuple::ph_dphi_Wlep()
	{
	...
	const float &StopNTuple::ph_MT2W()
	{
	...
	const float &StopNTuple::ph_topness()
	{
	...
	const float &StopNTuple::ph_topnessMod()
	{
	...
	const float &StopNTuple::ph_MT2_lb_b_mass()
	{
	...
	const float &StopNTuple::ph_MT2_lb_b()
	{
	...
	const float &StopNTuple::ph_MT2_lb_bqq_mass()
	{
	...
	const float &StopNTuple::ph_MT2_lb_bqq()
	{
	...
	const float &StopNTuple::ph_hadronic_top_chi2()
	{
	...
	const float &StopNTuple::ph_mindphi_met_j1_j2()
	{
	...
	const float &StopNTuple::ph_Mlb_lead_bdiscr()
	{
	...
	const float &StopNTuple::ph_dR_lep_leadb()
	{
	...
	const float &StopNTuple::ph_Mlb_closestb()
	{
	...
	const float &StopNTuple::ph_Mjjj()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::Zll_p4l1()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::Zll_p4l2()
	{
	...
	const bool &	StopNTuple::Zll_isZmass()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::Zll_p4()
	{
	...
	const int &StopNTuple::Zll_selLep()
	{
	...
	const float &StopNTuple::Zll_met()
	{
	...
	const float &StopNTuple::Zll_met_phi()
	{
	...
	const float &StopNTuple::Zll_mindphi_met_j1_j2()
	{
	...
	const float &StopNTuple::Zll_mt_met_lep()
	{
	...
	const float &StopNTuple::Zll_dphi_Wlep()
	{
	...
	const float &StopNTuple::Zll_MT2W()
	{
	...
	const float &StopNTuple::Zll_topness()
	{
	...
	const float &StopNTuple::Zll_topnessMod()
	{
	...
	const float &StopNTuple::Zll_MT2_lb_b_mass()
	{
	...
	const float &StopNTuple::Zll_MT2_lb_b()
	{
	...
	const float &StopNTuple::Zll_MT2_lb_bqq_mass()
	{
	...
	const float &StopNTuple::Zll_MT2_lb_bqq()
	{
	...
	const bool &	StopNTuple::lep1_is_mu()
	{
	...
	const bool &	StopNTuple::lep1_is_el()
	{
	...
	const int &StopNTuple::lep1_charge()
	{
	...
	const int &StopNTuple::lep1_pdgid()
	{
	...
	const int &StopNTuple::lep1_type()
	{
	...
	const int &StopNTuple::lep1_production_type()
	{
	...
	const float &StopNTuple::lep1_d0()
	{
	...
	const float &StopNTuple::lep1_d0err()
	{
	...
	const float &StopNTuple::lep1_dz()
	{
	...
	const float &StopNTuple::lep1_dzerr()
	{
	...
	const float &StopNTuple::lep1_sigmaIEtaEta_fill5x5()
	{
	...
	const float &StopNTuple::lep1_dEtaIn()
	{
	...
	const float &StopNTuple::lep1_dPhiIn()
	{
	...
	const float &StopNTuple::lep1_hOverE()
	{
	...
	const float &StopNTuple::lep1_ooEmooP()
	{
	...
	const int &StopNTuple::lep1_expectedMissingInnerHits()
	{
	...
	const bool &	StopNTuple::lep1_conversionVeto()
	{
	...
	const float &StopNTuple::lep1_etaSC()
	{
	...
	const float &StopNTuple::lep1_ChiSqr()
	{
	...
	const float &StopNTuple::lep1_chiso()
	{
	...
	const float &StopNTuple::lep1_nhiso()
	{
	...
	const float &StopNTuple::lep1_emiso()
	{
	...
	const float &StopNTuple::lep1_deltaBeta()
	{
	...
	const float &StopNTuple::lep1_relIso03DB()
	{
	...
	const float &StopNTuple::lep1_relIso03EA()
	{
	...
	const float &StopNTuple::lep1_relIso04DB()
	{
	...
	const float &StopNTuple::lep1_miniRelIsoDB()
	{
	...
	const float &StopNTuple::lep1_miniRelIsoEA()
	{
	...
	const float &StopNTuple::lep1_MiniIso()
	{
	...
	const int &StopNTuple::lep1_mcid()
	{
	...
	const int &StopNTuple::lep1_mcstatus()
	{
	...
	const int &StopNTuple::lep1_mc3dr()
	{
	...
	const int &StopNTuple::lep1_mc3id()
	{
	...
	const int &StopNTuple::lep1_mc3idx()
	{
	...
	const int &StopNTuple::lep1_mc3motherid()
	{
	...
	const int &StopNTuple::lep1_mc3motheridx()
	{
	...
	const bool &	StopNTuple::lep1_is_eleid_loose()
	{
	...
	const bool &	StopNTuple::lep1_is_eleid_medium()
	{
	...
	const bool &	StopNTuple::lep1_is_eleid_tight()
	{
	...
	const bool &	StopNTuple::lep1_is_phys14_loose_noIso()
	{
	...
	const bool &	StopNTuple::lep1_is_phys14_medium_noIso()
	{
	...
	const bool &	StopNTuple::lep1_is_phys14_tight_noIso()
	{
	...
	const float &StopNTuple::lep1_eoverpin()
	{
	...
	const bool &	StopNTuple::lep1_is_muoid_loose()
	{
	...
	const bool &	StopNTuple::lep1_is_muoid_medium()
	{
	...
	const bool &	StopNTuple::lep1_is_muoid_tight()
	{
	...
	const float &StopNTuple::lep1_ip3d()
	{
	...
	const float &StopNTuple::lep1_ip3derr()
	{
	...
	const bool &	StopNTuple::lep1_is_pfmu()
	{
	...
	const bool &	StopNTuple::lep1_passMediumID()
	{
	...
	const bool &	StopNTuple::lep1_passVeto()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::lep1_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::lep1_mcp4()
	{
	...
	const float &StopNTuple::lep1_pt()
	{
	...
	const float &StopNTuple::lep1_eta()
	{
	...
	const float &StopNTuple::lep1_phi()
	{
	...
	const float &StopNTuple::lep1_mass()
	{
	...
	const bool &	StopNTuple::lep2_is_mu()
	{
	...
	const bool &	StopNTuple::lep2_is_el()
	{
	...
	const int &StopNTuple::lep2_charge()
	{
	...
	const int &StopNTuple::lep2_pdgid()
	{
	...
	const int &StopNTuple::lep2_type()
	{
	...
	const int &StopNTuple::lep2_production_type()
	{
	...
	const float &StopNTuple::lep2_d0()
	{
	...
	const float &StopNTuple::lep2_d0err()
	{
	...
	const float &StopNTuple::lep2_dz()
	{
	...
	const float &StopNTuple::lep2_dzerr()
	{
	...
	const float &StopNTuple::lep2_sigmaIEtaEta_fill5x5()
	{
	...
	const float &StopNTuple::lep2_dEtaIn()
	{
	...
	const float &StopNTuple::lep2_dPhiIn()
	{
	...
	const float &StopNTuple::lep2_hOverE()
	{
	...
	const float &StopNTuple::lep2_ooEmooP()
	{
	...
	const int &StopNTuple::lep2_expectedMissingInnerHits()
	{
	...
	const bool &	StopNTuple::lep2_conversionVeto()
	{
	...
	const float &StopNTuple::lep2_etaSC()
	{
	...
	const float &StopNTuple::lep2_ChiSqr()
	{
	...
	const float &StopNTuple::lep2_chiso()
	{
	...
	const float &StopNTuple::lep2_nhiso()
	{
	...
	const float &StopNTuple::lep2_emiso()
	{
	...
	const float &StopNTuple::lep2_deltaBeta()
	{
	...
	const float &StopNTuple::lep2_relIso03DB()
	{
	...
	const float &StopNTuple::lep2_relIso03EA()
	{
	...
	const float &StopNTuple::lep2_relIso04DB()
	{
	...
	const float &StopNTuple::lep2_miniRelIsoDB()
	{
	...
	const float &StopNTuple::lep2_miniRelIsoEA()
	{
	...
	const float &StopNTuple::lep2_MiniIso()
	{
	...
	const int &StopNTuple::lep2_mcid()
	{
	...
	const int &StopNTuple::lep2_mcstatus()
	{
	...
	const int &StopNTuple::lep2_mc3dr()
	{
	...
	const int &StopNTuple::lep2_mc3id()
	{
	...
	const int &StopNTuple::lep2_mc3idx()
	{
	...
	const int &StopNTuple::lep2_mc3motherid()
	{
	...
	const int &StopNTuple::lep2_mc3motheridx()
	{
	...
	const bool &	StopNTuple::lep2_is_eleid_loose()
	{
	...
	const bool &	StopNTuple::lep2_is_eleid_medium()
	{
	...
	const bool &	StopNTuple::lep2_is_eleid_tight()
	{
	...
	const bool &	StopNTuple::lep2_is_phys14_loose_noIso()
	{
	...
	const bool &	StopNTuple::lep2_is_phys14_medium_noIso()
	{
	...
	const bool &	StopNTuple::lep2_is_phys14_tight_noIso()
	{
	...
	const float &StopNTuple::lep2_eoverpin()
	{
	...
	const bool &	StopNTuple::lep2_is_muoid_loose()
	{
	...
	const bool &	StopNTuple::lep2_is_muoid_medium()
	{
	...
	const bool &	StopNTuple::lep2_is_muoid_tight()
	{
	...
	const float &StopNTuple::lep2_ip3d()
	{
	...
	const float &StopNTuple::lep2_ip3derr()
	{
	...
	const bool &	StopNTuple::lep2_is_pfmu()
	{
	...
	const bool &	StopNTuple::lep2_passMediumID()
	{
	...
	const bool &	StopNTuple::lep2_passVeto()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::lep2_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::lep2_mcp4()
	{
	...
	const float &StopNTuple::lep2_pt()
	{
	...
	const float &StopNTuple::lep2_eta()
	{
	...
	const float &StopNTuple::lep2_phi()
	{
	...
	const float &StopNTuple::lep2_mass()
	{
	...
	const vector<float> &StopNTuple::ph_sigmaIEtaEta_fill5x5()
	{
	...
	const vector<float> &StopNTuple::ph_hOverE()
	{
	...
	const vector<float> &StopNTuple::ph_r9()
	{
	...
	const vector<float> &StopNTuple::ph_chiso()
	{
	...
	const vector<float> &StopNTuple::ph_nhiso()
	{
	...
	const vector<float> &StopNTuple::ph_phiso()
	{
	...
	const vector<bool> &StopNTuple::ph_idCutBased()
	{
	...
	const vector<int> &StopNTuple::ph_overlapJetId()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::ph_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::ph_mcp4()
	{
	...
	const vector<float> &StopNTuple::ph_pt()
	{
	...
	const vector<float> &StopNTuple::ph_eta()
	{
	...
	const vector<float> &StopNTuple::ph_phi()
	{
	...
	const vector<float> &StopNTuple::ph_mass()
	{
	...
	const vector<int> &StopNTuple::ph_mcMatchId()
	{
	...
	const vector<float> &StopNTuple::ph_genIso04()
	{
	...
	const vector<float> &StopNTuple::ph_drMinParton()
	{
	...
	const int &StopNTuple::nGoodGenJets()
	{
	...
	const int &StopNTuple::ngoodjets()
	{
	...
	const int &StopNTuple::nfailjets()
	{
	...
	const int &StopNTuple::ak8GoodPFJets()
	{
	...
	const int &StopNTuple::ngoodbtags()
	{
	...
	const float &StopNTuple::ak4_htssm()
	{
	...
	const float &StopNTuple::ak4_htosm()
	{
	...
	const float &StopNTuple::ak4_htratiom()
	{
	...
	const vector<float> &StopNTuple::dphi_ak4pfjet_met()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::ak4pfjets_p4()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_pt()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_eta()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_phi()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_mass()
	{
	...
	const vector<bool> &StopNTuple::ak4pfjets_passMEDbtag()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_qg_disc()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_CSV()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_puid()
	{
	...
	const vector<int> &StopNTuple::ak4pfjets_parton_flavor()
	{
	...
	const vector<int> &StopNTuple::ak4pfjets_hadron_flavor()
	{
	...
	const vector<bool> &StopNTuple::ak4pfjets_loose_puid()
	{
	...
	const vector<bool> &StopNTuple::ak4pfjets_loose_pfid()
	{
	...
	const vector<bool> &StopNTuple::ak4pfjets_medium_pfid()
	{
	...
	const vector<bool> &StopNTuple::ak4pfjets_tight_pfid()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_MEDbjet_pt()
	{
	...
	const float &StopNTuple::ak4pfjets_leadMEDbjet_pt()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::ak4pfjets_leadMEDbjet_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::ak4pfjets_leadbtag_p4()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_chf()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_nhf()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_cef()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_nef()
	{
	...
	const vector<float> &StopNTuple::ak4pfjets_muf()
	{
	...
	const vector<int> &StopNTuple::ak4pfjets_cm()
	{
	...
	const vector<int> &StopNTuple::ak4pfjets_nm()
	{
	...
	const vector<int> &StopNTuple::ak4pfjets_mc3dr()
	{
	...
	const vector<int> &StopNTuple::ak4pfjets_mc3id()
	{
	...
	const vector<int> &StopNTuple::ak4pfjets_mc3idx()
	{
	...
	const vector<int> &StopNTuple::ak4pfjets_mcmotherid()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::ak4pfjet_overlep1_p4()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep1_CSV()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep1_pu_id()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep1_chf()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep1_nhf()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep1_cef()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep1_nef()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep1_muf()
	{
	...
	const int &StopNTuple::ak4pfjet_overlep1_cm()
	{
	...
	const int &StopNTuple::ak4pfjet_overlep1_nm()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &StopNTuple::ak4pfjet_overlep2_p4()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep2_CSV()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep2_pu_id()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep2_chf()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep2_nhf()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep2_cef()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep2_nef()
	{
	...
	const float &StopNTuple::ak4pfjet_overlep2_muf()
	{
	...
	const int &StopNTuple::ak4pfjet_overlep2_cm()
	{
	...
	const int &StopNTuple::ak4pfjet_overlep2_nm()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::ak8pfjets_p4()
	{
	...
	const vector<float> &StopNTuple::ak8pfjets_tau1()
	{
	...
	const vector<float> &StopNTuple::ak8pfjets_tau2()
	{
	...
	const vector<float> &StopNTuple::ak8pfjets_tau3()
	{
	...
	const vector<float> &StopNTuple::ak8pfjets_top_mass()
	{
	...
	const vector<float> &StopNTuple::ak8pfjets_pruned_mass()
	{
	...
	const vector<float> &StopNTuple::ak8pfjets_trimmed_mass()
	{
	...
	const vector<float> &StopNTuple::ak8pfjets_filtered_mass()
	{
	...
	const vector<float> &StopNTuple::ak8pfjets_pu_id()
	{
	...
	const vector<int> &StopNTuple::ak8pfjets_parton_flavor()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::ak4genjets_p4()
	{
	...
	const vector<TString> &StopNTuple::tau_IDnames()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::tau_leadtrack_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::tau_leadneutral_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::tau_p4()
	{
	...
	const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &StopNTuple::tau_isocand_p4()
	{
	...
	const vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > > &StopNTuple::tau_sigcand_p4()
	{
	...
	const vector<float> &StopNTuple::tau_mass()
	{
	...
	const vector<vector<float> > &StopNTuple::tau_ID()
	{
	...
	const vector<float> &StopNTuple::tau_passID()
	{
	...
	const vector<float> &StopNTuple::tau_charge()
	{
	...
	const int &StopNTuple::ngoodtaus()
	{
	...
	const vector<float> &StopNTuple::tau_againstMuonTight()
	{
	...
	const vector<float> &StopNTuple::tau_againstElectronLoose()
	{
	...
	const vector<bool> &StopNTuple::tau_isVetoTau()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::isoTracks_p4()
	{
	...
	const vector<int> &StopNTuple::isoTracks_charge()
	{
	...
	const vector<float> &StopNTuple::isoTracks_absIso()
	{
	...
	const vector<float> &StopNTuple::isoTracks_dz()
	{
	...
	const vector<int> &StopNTuple::isoTracks_pdgId()
	{
	...
	const vector<int> &StopNTuple::isoTracks_selectedidx()
	{
	...
	const int &StopNTuple::isoTracks_nselected()
	{
	...
	const vector<bool> &StopNTuple::isoTracks_isVetoTrack()
	{
	...
	const vector<bool> &StopNTuple::isoTracks_isVetoTrack_v2()
	{
	...
	const vector<bool> &StopNTuple::isoTracks_isVetoTrack_v3()
	{
	...
	const vector<bool> &StopNTuple::genleps_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genleps_p4()
	{
	...
	const vector<int> &StopNTuple::genleps_id()
	{
	...
	const vector<int> &StopNTuple::genleps__genpsidx()
	{
	...
	const vector<int> &StopNTuple::genleps_status()
	{
	...
	const vector<bool> &StopNTuple::genleps_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopNTuple::genleps_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopNTuple::genleps_isHardProcess()
	{
	...
	const vector<bool> &StopNTuple::genleps_isLastCopy()
	{
	...
	const vector<int> &StopNTuple::genleps_gentaudecay()
	{
	...
	const int &StopNTuple::gen_nfromtleps_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genleps_motherp4()
	{
	...
	const vector<int> &StopNTuple::genleps_motherid()
	{
	...
	const vector<int> &StopNTuple::genleps_motheridx()
	{
	...
	const vector<int> &StopNTuple::genleps_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genleps_gmotherp4()
	{
	...
	const vector<int> &StopNTuple::genleps_gmotherid()
	{
	...
	const vector<int> &StopNTuple::genleps_gmotheridx()
	{
	...
	const vector<int> &StopNTuple::genleps_gmotherstatus()
	{
	...
	const vector<bool> &StopNTuple::gennus_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gennus_p4()
	{
	...
	const vector<int> &StopNTuple::gennus_id()
	{
	...
	const vector<int> &StopNTuple::gennus__genpsidx()
	{
	...
	const vector<int> &StopNTuple::gennus_status()
	{
	...
	const vector<bool> &StopNTuple::gennus_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopNTuple::gennus_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopNTuple::gennus_isHardProcess()
	{
	...
	const vector<bool> &StopNTuple::gennus_isLastCopy()
	{
	...
	const vector<int> &StopNTuple::gennus_gentaudecay()
	{
	...
	const int &StopNTuple::gen_nfromtnus_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gennus_motherp4()
	{
	...
	const vector<int> &StopNTuple::gennus_motherid()
	{
	...
	const vector<int> &StopNTuple::gennus_motheridx()
	{
	...
	const vector<int> &StopNTuple::gennus_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gennus_gmotherp4()
	{
	...
	const vector<int> &StopNTuple::gennus_gmotherid()
	{
	...
	const vector<int> &StopNTuple::gennus_gmotheridx()
	{
	...
	const vector<int> &StopNTuple::gennus_gmotherstatus()
	{
	...
	const vector<bool> &StopNTuple::gents_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gents_p4()
	{
	...
	const vector<int> &StopNTuple::gents_id()
	{
	...
	const vector<int> &StopNTuple::gents__genpsidx()
	{
	...
	const vector<int> &StopNTuple::gents_status()
	{
	...
	const vector<bool> &StopNTuple::gents_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopNTuple::gents_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopNTuple::gents_isHardProcess()
	{
	...
	const vector<bool> &StopNTuple::gents_isLastCopy()
	{
	...
	const vector<int> &StopNTuple::gents_gentaudecay()
	{
	...
	const int &StopNTuple::gen_nfromtts_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gents_motherp4()
	{
	...
	const vector<int> &StopNTuple::gents_motherid()
	{
	...
	const vector<int> &StopNTuple::gents_motheridx()
	{
	...
	const vector<int> &StopNTuple::gents_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gents_gmotherp4()
	{
	...
	const vector<int> &StopNTuple::gents_gmotherid()
	{
	...
	const vector<int> &StopNTuple::gents_gmotheridx()
	{
	...
	const vector<int> &StopNTuple::gents_gmotherstatus()
	{
	...
	const vector<bool> &StopNTuple::genqs_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genqs_p4()
	{
	...
	const vector<int> &StopNTuple::genqs_id()
	{
	...
	const vector<int> &StopNTuple::genqs__genpsidx()
	{
	...
	const vector<int> &StopNTuple::genqs_status()
	{
	...
	const vector<bool> &StopNTuple::genqs_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopNTuple::genqs_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopNTuple::genqs_isHardProcess()
	{
	...
	const vector<bool> &StopNTuple::genqs_isLastCopy()
	{
	...
	const vector<int> &StopNTuple::genqs_gentaudecay()
	{
	...
	const int &StopNTuple::gen_nfromtqs_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genqs_motherp4()
	{
	...
	const vector<int> &StopNTuple::genqs_motherid()
	{
	...
	const vector<int> &StopNTuple::genqs_motheridx()
	{
	...
	const vector<int> &StopNTuple::genqs_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genqs_gmotherp4()
	{
	...
	const vector<int> &StopNTuple::genqs_gmotherid()
	{
	...
	const vector<int> &StopNTuple::genqs_gmotheridx()
	{
	...
	const vector<int> &StopNTuple::genqs_gmotherstatus()
	{
	...
	const vector<bool> &StopNTuple::genbosons_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genbosons_p4()
	{
	...
	const vector<int> &StopNTuple::genbosons_id()
	{
	...
	const vector<int> &StopNTuple::genbosons__genpsidx()
	{
	...
	const vector<int> &StopNTuple::genbosons_status()
	{
	...
	const vector<bool> &StopNTuple::genbosons_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopNTuple::genbosons_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopNTuple::genbosons_isHardProcess()
	{
	...
	const vector<bool> &StopNTuple::genbosons_isLastCopy()
	{
	...
	const vector<int> &StopNTuple::genbosons_gentaudecay()
	{
	...
	const int &StopNTuple::gen_nfromtbosons_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genbosons_motherp4()
	{
	...
	const vector<int> &StopNTuple::genbosons_motherid()
	{
	...
	const vector<int> &StopNTuple::genbosons_motheridx()
	{
	...
	const vector<int> &StopNTuple::genbosons_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::genbosons_gmotherp4()
	{
	...
	const vector<int> &StopNTuple::genbosons_gmotherid()
	{
	...
	const vector<int> &StopNTuple::genbosons_gmotheridx()
	{
	...
	const vector<int> &StopNTuple::genbosons_gmotherstatus()
	{
	...
	const vector<bool> &StopNTuple::gensusy_isfromt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gensusy_p4()
	{
	...
	const vector<int> &StopNTuple::gensusy_id()
	{
	...
	const vector<int> &StopNTuple::gensusy__genpsidx()
	{
	...
	const vector<int> &StopNTuple::gensusy_status()
	{
	...
	const vector<bool> &StopNTuple::gensusy_fromHardProcessDecayed()
	{
	...
	const vector<bool> &StopNTuple::gensusy_fromHardProcessFinalState()
	{
	...
	const vector<bool> &StopNTuple::gensusy_isHardProcess()
	{
	...
	const vector<bool> &StopNTuple::gensusy_isLastCopy()
	{
	...
	const vector<int> &StopNTuple::gensusy_gentaudecay()
	{
	...
	const int &StopNTuple::gen_nfromtsusy_()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gensusy_motherp4()
	{
	...
	const vector<int> &StopNTuple::gensusy_motherid()
	{
	...
	const vector<int> &StopNTuple::gensusy_motheridx()
	{
	...
	const vector<int> &StopNTuple::gensusy_motherstatus()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &StopNTuple::gensusy_gmotherp4()
	{
	...
	const vector<int> &StopNTuple::gensusy_gmotherid()
	{
	...
	const vector<int> &StopNTuple::gensusy_gmotheridx()
	{
	...
	const vector<int> &StopNTuple::gensusy_gmotherstatus()
	{
  ...
  void StopNTuple::progress( int nEventsTotal, int nEventsChain ){
    int period = 1000;
